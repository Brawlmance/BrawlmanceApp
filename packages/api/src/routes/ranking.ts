...
export default function rankingRoutes(app: Express): void {
  app.get('/v1/ranking/legend/:legend_id', async function (req: Request, res: Response) {
  ...
  app.get('/v1/ranking/user/:user_id', async function (req: Request, res: Response) {
